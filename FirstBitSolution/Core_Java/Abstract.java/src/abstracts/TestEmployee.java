...
class HR extends Employee {
    ...
    public String toString() {
    	return super.toString()+"Team Size : "
    +this.teamSize+"\n"+"Region : "+this.region;
    }
}
...
class SalesManager extends Employee {
    ...
    public String toString() {
    	return super.toString()+"Sales Target : "+this.salesTarget+"Commision Rate : "+this.commissionRate;
    }
}
...
class Developer extends Employee {
    ...
    public String toString() { 
    	return super.toString()+"Programming Language : "+this.programmingLanguage+"Project Name : "+this.projectName;
    }
}
