...
abstract class Farmer {
    ...
    Farmer(int farmerId, String farmerName, double landArea, String city,
           double annualIncome, double insuranceAmount){
...
class DairyFarmer extends Farmer {
    ...
    DairyFarmer(int farmerId, String farmerName, double landArea, String city,
                double annualIncome, double insuranceAmount,
                int noOfCattles, double milkProducePerDay, int dairyLicenceNo){
    ...
    double calculateIncome(){
        return annualIncome + (milkProducePerDay * noOfCattles * 20);
    }

    public String toString(){
        return "----- Dairy Farmer -----\n" + super.toString() +
               "\nNo. of Cattles: " + noOfCattles +
               "\nMilk Produce per Day: " + milkProducePerDay +
...
class PoultryFarmer extends Farmer {
    ...
    PoultryFarmer(int farmerId, String farmerName, double landArea, String city,
                  double annualIncome, double insuranceAmount,
                  int noOfChickens, int noOfHens, int noOfShed,
                  int eggProducePerDay, String poultryFarmName){
        super(farmerId, farmerName, landArea, city, annualIncome, insuranceAmount);
    ...
    double calculateIncome(){
        return annualIncome + (eggProducePerDay * 5);
    }
    ...
    public String toString(){
        return "----- Poultry Farmer -----\n" + super.toString() +
               ...
               "\nNo. of Hens: " + noOfHens +
               "\nNo. of Sheds: " + noOfShed +
               "\nEgg Produce Per Day: " + eggProducePerDay +
...
class OrganicFarmer extends Farmer {
    ...
    OrganicFarmer(int farmerId, String farmerName, double landArea, String city,
                  double annualIncome, double insuranceAmount,
                  int organicEstId, String cropType, String fertilizerUsed){
        super(farmerId, farmerName, landArea, city, annualIncome, insuranceAmount);
    ...
    double calculateIncome(){
        return annualIncome + (landArea * 100);
    }

    public String toString(){
        return "----- Organic Farmer -----\n" + super.toString() +
               "\nOrganic Est Id: " + organicEstId +
               "\nCrop Type: " + cropType +
...
class TestFarmer {
    public static void main(String[] args) {
        ...
        f = new DairyFarmer();
        System.out.println("Income: " + f.calculateIncome());
